...
from utils.modeling_lstm import SimpleLSTM
from utils.text import normalize
from utils.trainer import Trainer
from utils.utils import to_indexes, pad
...
class _LSTMBase(Trainer):
    ...
    def to_device(text, bert_prob, real_label):
        text = text.to(torch.device("cpu"))
        bert_prob = bert_prob.to(torch.device("cpu"))
        real_label = real_label.to(torch.device("cpu"))
